...
public class ContextAttributesTest
{
    ...
    public void ShouldAllowExplicitCategoricalAttributes()
    {
        ...
        var numericAttrs = new Dictionary<string, object?>() { { "accountAge", 0.5 } };
        var expectedNumeric = new Dictionary<string, double>() { { "accountAge", 0.5 } };
        var expectedStrings = new Dictionary<string, string>()
        {
            { "age", "30" },
            { "tier", "4" },
        ...
        var actual = ContextAttributes.FromNullableAttributes(
            "context",
            categoryAttrs,
            numericAttrs
        );
    ...
    public void Add_InvalidType_ThrowsInvalidAttributeTypeException()
    {
        ...
        Assert.Throws<InvalidAttributeTypeException>(() =>
            contextAttributes.Add("key1", new object())
        );
    }
    ...
    public void Add_InvalidType_ExceptionContainsKeyAndValue()
    {
        ...
        var exception = Assert.Throws<InvalidAttributeTypeException>(() =>
            contextAttributes.Add("key1", invalidValue)
        );
        Assert.Multiple(() =>
        {
